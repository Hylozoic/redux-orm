 ...
 */
var Model = function () {
    Model.createClass = function createClass(instanceMethods) {
        var klass = function (_Model) {
            (0, _inherits3.default)(ModelSubclass, _Model);

            function ModelSubclass() {
                (0, _classCallCheck3.default)(this, ModelSubclass);
                return (0, _possibleConstructorReturn3.default)(this, _Model.apply(this, arguments));
            }

            return ModelSubclass;
        }(Model);
        (0, _keys2.default)(instanceMethods).forEach(function (key) {
    ...
    Model.prototype._initFields = function _initFields(props) {
        ...
        (0, _forOwn2.default)(props, function (fieldValue, fieldName) {
            ...
            if (!(fieldName in _this2)) {
                (0, _defineProperty3.default)(_this2, fieldName, {
                    get: function get() {
                        return _this2._fields[fieldName];
                    },
                    set: function set(value) {
                        return _this2.set(fieldName, value);
                    },
                    configurable: true,
                    enumerable: true
                });
    ...
    Model.prototype._refreshMany2Many = function _refreshMany2Many(relations) {
        ...
        (0, _keys2.default)(relations).forEach(function (name) {
            ...
            var currentIds = ThroughModel.filter(function (through) {
                return through[fromField] === _this3[ThisModel.idAttribute];
            ...
            if (diffActions) {
                ...
                if (idsToDelete.length > 0) {
                    ...
                    (_name = _this3[name]).remove.apply(_name, (0, _toConsumableArray3.default)(idsToDelete));
                }
                if (idsToAdd.length > 0) {
                    var _name2;

                    (_name2 = _this3[name]).add.apply(_name2, (0, _toConsumableArray3.default)(idsToAdd));
                }
            }
        });
    };
    ...
    Model.create = function create(userProps) {
        ...
        declaredVirtualFieldNames.forEach(function (key) {
            if (!m2mRelations.hasOwnProperty(key)) {
                var field = _this4.virtualFields[key];
    ...
    Model.prototype.toString = function toString() {
        ...
        var fields = fieldNames.map(function (fieldName) {
            ...
            if (field instanceof _fields.ManyToMany) {
                var ids = _this5[fieldName].toModelArray().map(function (model) {
                    return model.getId();
                });
                return fieldName + ': [' + ids.join(', ') + ']';
            }
            var val = _this5._fields[fieldName];
